...
class ViewModelRaceSizeImpl(
    ...
    override fun successGetPetRaces(listPetRaces: List<PetRaceItemModel>) {
        ...
        listPetRaces.forEach { item ->
            val modifiedItem =
                if (item.name.startsWith(OTHER_RACE)) {
    ...
    override fun change(
        ...
        when {
            petSize != null -> {
                ...
                state =
                    if (result.success) {
                        state.copy(sizeError = null)
                    } else {
                        state.copy(sizeError = result.errorMessage)
                    }
            }
            ...
            petRace != null -> {
                ...
                state =
                    if (result.success) {
                        state.copy(raceError = null)
                    } else {
                        state.copy(raceError = result.errorMessage)
                    }
            }
            ...
            petRaceOthers != null -> {
                ...
                state =
                    if (result.success) {
                        state.copy(raceOthersError = null)
                    } else {
                        state.copy(raceOthersError = result.errorMessage)
                    }
            }
        }
    }
