    ...
    override fun change(
        ...
        when {
            ...
            lastName != null -> {
                ...
                val lastNameResult = validation.validateLastName(state.lastName)
                state =
                    if (hasError(lastNameResult)) {
                        state.copy(lastNameError = lastNameResult.errorMessage)
                    } else {
            ...
            phone != null -> {
                ...
                val phoneResult = validation.validatePhone(state.phone)
                state =
                    if (hasError(phoneResult)) {
                        state.copy(phoneError = phoneResult.errorMessage)
                    } else {
                        state.copy(phoneError = null)
                    }
            }
            ...
            repeatedPassword != null -> {
                ...
                state =
                    if (hasError(repeatedPasswordResult)) {
                        state.copy(repeatedPasswordError = repeatedPasswordResult.errorMessage)
                    } else {
                        state.copy(repeatedPasswordError = null)
                    }
            }
            ...
            privacy != null -> {
                ...
                state =
                    if (hasError(privacyPolicyResult)) {
                        state.copy(privacyPolicy = privacyPolicyResult.success)
                    } else {
                        state.copy(repeatedPasswordError = null)
                    }
            }
