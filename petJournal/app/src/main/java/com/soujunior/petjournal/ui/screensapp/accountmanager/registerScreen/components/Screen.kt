package com.soujunior.petjournal.ui.screensapp.accountmanager.registerScreen.components
...
import com.soujunior.petjournal.ui.screensapp.accountmanager.registerScreen.FakeRegisterViewModel
import com.soujunior.petjournal.ui.screensapp.accountmanager.registerScreen.RegisterFormEvent
...
fun Screen(
    ...
    viewModel: RegisterViewModel = getRegisterGuardianViewModelForPreview(),
) {
                    ...
                    item {
                        Row(
                            ...
                            modifier =
                                Modifier
                                    .fillMaxWidth()
                                    .padding(start = 10.sdp, end = 24.sdp, top = 32.sdp),
                        ) {
                            Text(
                                text = "Inscreva-se:",
