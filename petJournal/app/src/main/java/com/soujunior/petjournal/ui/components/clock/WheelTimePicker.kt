...
fun WheelTimePicker(
    ...
    Row(
        ...
        // CORREÇÃO: Envolve o Text em um Box para garantir alinhamento vertical perfeito.
        Box(
...
private fun PickerColumn(
    ...
    // CORREÇÃO: Lógica de "snap" (mola/roleta) que puxa o item mais próximo para o centro.
