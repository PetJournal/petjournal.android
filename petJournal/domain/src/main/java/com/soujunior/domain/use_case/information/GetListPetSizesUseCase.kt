package com.soujunior.domain.use_case.information
...
class GetListPetSizesUseCase(private val repository: Repository): BaseUseCase<String, List<PetSizeItemModel>>() {
